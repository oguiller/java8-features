...
public class MapEmployees {
    public static List<Employee> createEmployees() {
        return Arrays.asList(
                new Employee(1, "Guillermo Rodriguez"),
                new Employee(2, "Balbina Fernandez"),
                new Employee(3, "Jose Luis Rodriguez"),
                new Employee(4, "Iria Rodriguez")
        );
    }
...
//                });
        ...
        System.out.println("Reverse 1 sorted by key:");
        employeeMap.entrySet().stream()
        ...
        // Reverse sort employees by id and print them
        System.out.println("Reverse 2 sorted by key:");
        employeeMap.entrySet().stream()
